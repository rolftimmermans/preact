!(function(n, l) {
	...
	function w(n, l, u, i, t, o, f, r, e, a) {
		...
		for (u.__k = [], h = 0; h < l.length; h++)
			if (
				...
				(_ = u.__k[h] =
					null == (_ = l[h]) || 'boolean' == typeof _
						...
						: 'string' == typeof _ ||
						  'number' == typeof _ ||
						  'bigint' == typeof _
						? p(null, _, null, null, _)
						: Array.isArray(_)
						? p(d, { children: _ }, null, null, null)
						: _.__b > 0
						? p(_.type, _.props, _.key, null, _.__v)
						: _)
			) {
				if (
					((_.__ = u),
					(_.__b = u.__b + 1),
					null === (y = w[h]) || (y && _.key == y.key && _.type === y.type))
				)
					w[h] = void 0;
				else
					for (v = 0; v < P; v++) {
				...
				I(n, _, (y = y || c), t, o, f, r, e, a),
					(k = _.__e),
					(v = _.ref) &&
						y.ref != v &&
						(g || (g = []),
						y.ref && g.push(y.ref, null, _),
						g.push(v, _.__c || k, _)),
					null != k
						? (null == m && (m = k),
						  'function' == typeof _.type && _.__k === y.__k
								? (_.__d = e = x(_, e, n))
								: (e = A(n, _, y, w, k, e)),
		...
		for (u.__e = m, h = P; h--; )
			null != w[h] &&
				('function' == typeof u.type &&
					...
					(u.__d = b(i, h + 1)),
				M(w[h], w[h]));
		if (g) for (h = 0; h < g.length; h++) L(g[h], g[++h], g[++h]);
	}
	function x(n, l, u) {
		for (var i, t = n.__k, o = 0; t && o < t.length; o++)
			(i = t[o]) &&
				((i.__ = n),
				(l =
					'function' == typeof i.type ? x(i, l, u) : A(u, i, i, t, i.__e, l)));
		return l;
	}
	...
	function P(n, l, u, i, t) {
		var o;
		for (o in u)
			'children' === o || 'key' === o || o in l || $(n, o, null, u[o], i);
		for (o in l)
	...
	function $(n, l, u, i, t) {
		...
		n: if ('style' === l)
			...
			(o = l !== (l = l.replace(/Capture$/, ''))),
				...
				(n.l[l + o] = u),
				u
					? i || n.addEventListener(l, o ? H : j, o)
					: n.removeEventListener(l, o ? H : j, o);
			...
			n: if ('function' == typeof P) {
				if (
					...
					null != P.getDerivedStateFromProps &&
						...
						h(a.__s, P.getDerivedStateFromProps(m, a.__s))),
					(y = a.props),
					(p = a.state),
					v)
				)
					...
					if (
						(null == P.getDerivedStateFromProps &&
							...
							a.componentWillReceiveProps(m, x),
						(!a.__e &&
							null != a.shouldComponentUpdate &&
							!1 === a.shouldComponentUpdate(m, a.__s, x)) ||
							l.__v === i.__v)
					) {
						(a.props = m),
							(a.state = a.__s),
					...
					null != a.componentWillUpdate && a.componentWillUpdate(m, a.__s, x),
				...
				(a.context = x),
					...
					v ||
						...
						(b = a.getSnapshotBeforeUpdate(y, p)),
					(A =
						null != s && s.type === d && null == s.key ? s.props.children : s),
					w(n, Array.isArray(A) ? A : [A], l, i, t, o, f, r, e, c),
					(a.base = l.__e),
					(l.__h = null),
					a.__h.length && r.push(a),
					k && (a.__E = a.__ = null),
	...
	function z(n, u, i, t, o, f, r, e) {
		...
		if (null === d) y === p || (e && n.data === p) || (n.data = p);
			...
			if (
				...
				if (null != f)
					for (y = {}, _ = 0; _ < n.attributes.length; _++)
						y[n.attributes[_].name] = n.attributes[_].value;
				(h || a) &&
					((h && ((a && h.__html == a.__html) || h.__html === n.innerHTML)) ||
	...
	function M(n, l, i) {
		...
		if ((t = n.__k))
			for (o = 0; o < t.length; o++)
				t[o] && M(t[o], l, 'function' != typeof n.type);
	...
	(l = s.slice),
		...
		(n.cloneElement = function(n, u, i) {
			...
			return (
				arguments.length > 2 &&
					(r.children = arguments.length > 3 ? l.call(arguments, 2) : i),
				p(n.type, r, t || n.key, o || n.ref, null)
			);
		}),
