...
function R(n, e) {
	function r(n) {
		...
		return (
			...
			e ? !e(this.props, n) || !r : C(this.props, n)
		);
	}
	function u(e) {
...
((w.prototype = new n()).isPureReactComponent = !0),
	...
	(e.componentWillUnmount = function() {
		...
		n.__v
			? (e.l ||
			  ...
			  o(t(P, { context: e.context }, n.__v), e.l))
...
e.vnode = function(n) {
	...
	if ('string' == typeof t) {
		...
		'select' == t &&
			...
			(u.value = r(e.children).forEach(function(n) {
...
export {
	...
	D as Suspense,
	V as SuspenseList,
	rn as __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
	cn as cloneElement,
	on as createFactory,
	j as createPortal,
	bn as default,
	...
	k as forwardRef,
	q as hydrate,
	ln as isValidElement,
	M as lazy,
	R as memo,
	Y as render,
	dn as startTransition,
	fn as unmountComponentAtNode,
	sn as unstable_batchedUpdates,
	pn as useDeferredValue,
	yn as useInsertionEffect,
	_n as useSyncExternalStore,
	mn as useTransition,
	un as version
};
