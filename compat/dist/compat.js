...
function u(n, e) {
	function o(n) {
		...
		return (
			...
			e ? !e(this.props, n) || !o : r(this.props, n)
		);
	}
	function u(e) {
...
(t.options.unmount = function(n) {
	...
	(h.prototype.render = function(n, r) {
					...
					return (
						t &&
							(t.__c &&
								...
								(t.__c.__H = null)),
							null != (t = e({}, t)).__c &&
								(t.__c.__P === o && (t.__c.__P = r), (t.__c = null)),
							(t.__k =
								t.__k &&
								t.__k.map(function(t) {
									return n(t, r, o);
		...
		return (
			i && (i.__h = null),
			[t.createElement(t.Fragment, null, r.__e ? null : n.children), i]
		);
	});
	...
	(e.componentWillUnmount = function() {
		...
		n.__v
			? (e.l ||
			  ...
			  t.render(t.createElement(y, { context: e.context }, n.__v), e.l))
			: e.l && e.componentWillUnmount();
}
function _(n, e) {
	return t.createElement(b, { __v: n, i: e });
}
((m.prototype = new t.Component()).__e = function(n) {
	var t = this,
		e = v(t.__v),
		r = t.u.get(n);
	return (
	...
	(m.prototype.render = function(n) {
		...
		for (var r = e.length; r--; ) this.u.set(e[r], (this.o = [1, 0, this.o]));
		return n.children;
	}),
...
t.options.vnode = function(n) {
	...
	if ('string' == typeof e) {
		...
		for (var i in ((o = {}), r)) {
			...
			(C && 'children' === i && 'noscript' === e) ||
				...
				('defaultValue' === i && 'value' in r && null == r.value
					...
					? (i = 'ondblclick')
					: /^onchange(textarea|input)/i.test(i + e) && !g(r.type)
					? (i = 'oninput')
					: /^onfocus$/i.test(i)
					? (i = 'onfocusin')
					: /^onblur$/i.test(i)
		...
		'select' == e &&
			...
			(o.value = t.toChildArray(r.children).forEach(function(n) {
				n.props.selected = -1 != o.value.indexOf(n.props.value);
			})),
			'select' == e &&
				null != o.defaultValue &&
				(o.value = t.toChildArray(r.children).forEach(function(n) {
					n.props.selected = o.multiple
						? -1 != o.defaultValue.indexOf(n.props.value)
						: o.defaultValue == n.props.value;
				})),
			(n.props = o),
			r.class != r.className &&
				((U.enumerable = 'className' in r),
				null != r.className && (o.class = r.className),
				Object.defineProperty(o, 'className', U));
	}
	(n.$$typeof = S), M && M(n);
};
var T = t.options.__r;
...
Object.keys(n).forEach(function(t) {
	...
	(exports.createPortal = _),
	(exports.createFactory = D),
	(exports.cloneElement = I),
	(exports.isValidElement = F),
	(exports.findDOMNode = P),
	...
	(exports.lazy = d),
	(exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = j),
	(exports.default = $);
