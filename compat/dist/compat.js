...
((o.prototype = new n.Component()).isPureReactComponent = !0),
...
(n.options.unmount = function(n) {
	...
	((m.prototype = new n.Component()).__c = function(n, t) {
		...
		var c = function() {
			...
			l = !0 === t.__h;
		r.__u++ || l || r.setState({ __a: (r.__b = r.__v.__k[0]) }), n.then(i, i);
	}),
	...
	(e.componentWillUnmount = function() {
		...
		t.__v
			? (e.l ||
			  ...
			  n.render(n.createElement(g, { context: e.context }, t.__v), e.l))
			: e.l && e.componentWillUnmount();
}
function C(t, e) {
	var r = n.createElement(S, { __v: t, i: e });
...
var E =
		...
		60103,
	O = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,
...
n.options.vnode = function(t) {
	...
	if ('string' == typeof e) {
		...
		for (var i in ((u = {}), r)) {
			var c = r[i];
			(w && 'children' === i && 'noscript' === e) ||
				('value' === i && 'defaultValue' in r && null == c) ||
				('defaultValue' === i && 'value' in r && null == r.value
					...
					? (i = 'ondblclick')
					: /^onchange(textarea|input)/i.test(i + e) && !R(r.type)
					? (i = 'oninput')
					: /^onfocus$/i.test(i)
					? (i = 'onfocusin')
					: /^onblur$/i.test(i)
		...
		'select' == e &&
			...
			(u.value = n.toChildArray(r.children).forEach(function(n) {
			...
			(t.props = u),
			r.class != r.className &&
				((U.enumerable = 'className' in r),
				null != r.className && (u.class = r.className),
				Object.defineProperty(u, 'className', U));
	}
	(t.$$typeof = E), D && D(t);
};
var F = n.options.__r;
...
function K(n, e) {
	var r = e(),
		o = t.useState({ p: { __: r, h: e } }),
		i = o[0].p,
		c = o[1];
	return (
		t.useLayoutEffect(
			function() {
				(i.__ = r), (i.h = e), u(i.__, e()) || c({ p: i });
			},
			[n, r, e]
		),
		t.useEffect(
...
Object.defineProperty(exports, 'Component', {
	...
	(exports.Suspense = m),
	(exports.SuspenseList = _),
	(exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = M),
	(exports.cloneElement = P),
	(exports.createFactory = V),
	...
	(exports.memo = i),
	(exports.render = j),
	(exports.startTransition = Z),
	(exports.unmountComponentAtNode = $),
	(exports.unstable_batchedUpdates = B),
	(exports.useDeferredValue = Y),
	(exports.useInsertionEffect = J),
	(exports.useSyncExternalStore = K),
	(exports.useTransition = G),
