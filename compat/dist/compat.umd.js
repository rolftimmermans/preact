!(function(n, t) {
	...
	(t.options.unmount = function(n) {
		var t = n.__c;
		t && t.__R && t.__R(), t && !0 === n.__h && (n.type = null), v && v(n);
	}),
		((b.prototype = new t.Component()).__c = function(n, t) {
			var e = t.__c,
				r = this;
			...
			var c = function() {
					if (!--r.__u) {
						if (r.state.__a) {
							var n = r.state.__a;
							r.__v.__k[0] = m(n, n.__c.__P, n.__c.__O);
						}
						var t;
				...
				f = !0 === t.__h;
			r.__u++ || f || r.setState({ __a: (r.__b = r.__v.__k[0]) }), n.then(o, o);
		}),
		(b.prototype.componentWillUnmount = function() {
			this.t = [];
		}),
		(b.prototype.render = function(n, e) {
			if (this.__b) {
				if (this.__v.__k) {
					var r = document.createElement('div'),
						u = this.__v.__k[0].__c;
					this.__v.__k[0] = p(this.__b, r, (u.__O = u.__P));
				}
				this.__b = null;
			}
			var i = e.__a && t.createElement(t.Fragment, null, n.fallback);
			return (
				i && (i.__h = null),
				[t.createElement(t.Fragment, null, e.__a ? null : n.children), i]
			);
		});
	...
	function E(n) {
		...
		(e.componentWillUnmount = function() {
			t.render(null, e.l), (e.l = null), (e.o = null);
		}),
			e.o && e.o !== r && e.componentWillUnmount(),
			n.__v
				? (e.l ||
						((e.o = r),
						(e.l = {
							...
							appendChild: function(n) {
								this.childNodes.push(n), e.o.appendChild(n);
							},
				  ...
				  t.render(t.createElement(C, { context: e.context }, n.__v), e.l))
				: e.l && e.componentWillUnmount();
	}
	function O(n, e) {
		var r = t.createElement(E, { __v: n, o: e });
		return (r.containerInfo = e), r;
	}
	((g.prototype = new t.Component()).__a = function(n) {
		var t = this,
			e = y(t.__v),
			r = t.i.get(n);
		return (
			...
			function(u) {
				var i = function() {
					t.props.revealOrder ? (r.push(u), S(t, n, r)) : u();
				};
				e ? e(i) : i();
			}
		);
	...
	t.options.vnode = function(n) {
		...
		if ('string' == typeof e) {
			...
			for (var o in ((u = {}), r)) {
				var c = r[o];
				(x && 'children' === o && 'noscript' === e) ||
					('value' === o && 'defaultValue' in r && null == c) ||
					('defaultValue' === o && 'value' in r && null == r.value
						...
						? (o = 'ondblclick')
						: /^onchange(textarea|input)/i.test(o + e) && !j(r.type)
						? (o = 'oninput')
						: /^onfocus$/i.test(o)
						? (o = 'onfocusin')
						: /^onblur$/i.test(o)
						...
						: null === c && (c = void 0),
					/^oninput$/i.test(o) &&
						((o = o.toLowerCase()), u[o] && (o = 'oninputCapture')),
					(u[o] = c));
			}
			'select' == e &&
				u.multiple &&
				Array.isArray(u.value) &&
				(u.value = t.toChildArray(r.children).forEach(function(n) {
				...
				(n.props = u),
				r.class != r.className &&
					((D.enumerable = 'className' in r),
					null != r.className && (u.class = r.className),
					Object.defineProperty(u, 'className', D));
		}
		(n.$$typeof = w), F && F(n);
	};
	var M = t.options.__r;
	...
	function z(n) {
		return $(n) ? t.cloneElement.apply(null, arguments) : n;
	}
	function B(n) {
	...
	Object.defineProperty(n, 'Component', {
		...
		(n.Suspense = b),
		(n.SuspenseList = g),
		(n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = V),
		(n.cloneElement = z),
		(n.createFactory = P),
		(n.createPortal = O),
		(n.default = nn),
		...
		(n.render = N),
		(n.startTransition = G),
		(n.unmountComponentAtNode = B),
		(n.unstable_batchedUpdates = H),
		(n.useDeferredValue = J),
		(n.useInsertionEffect = Q),
		(n.useSyncExternalStore = X),
		(n.useTransition = K),
		(n.version = W),
