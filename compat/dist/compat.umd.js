!(function(n, t) {
	...
	(e.options.unmount = function(n) {
		...
		((v.prototype = new e.Component()).__c = function(n, t) {
			...
			var l = function() {
				...
				f = !0 === t.__h;
			r.__u++ || f || r.setState({ __e: (r.__b = r.__v.__k[0]) }), n.then(o, o);
		}),
		...
		(t.componentWillUnmount = function() {
			...
			n.__v
				? (t.l ||
				  ...
				  e.render(e.createElement(_, { context: t.context }, n.__v), t.l))
				: t.l && t.componentWillUnmount();
	}
	function w(n, t) {
		return e.createElement(S, { __v: n, o: t });
	}
	...
	e.options.vnode = function(n) {
		...
		if ('string' == typeof t) {
			...
			for (var o in ((u = {}), r)) {
				var l = r[o];
				(E && 'children' === o && 'noscript' === t) ||
					('value' === o && 'defaultValue' in r && null == l) ||
					('defaultValue' === o && 'value' in r && null == r.value
						...
						? (o = 'ondblclick')
						: /^onchange(textarea|input)/i.test(o + t) && !R(r.type)
						? (o = 'oninput')
						: /^onfocus$/i.test(o)
						? (o = 'onfocusin')
						: /^onblur$/i.test(o)
